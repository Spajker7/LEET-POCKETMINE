...
class Chunk{
	 ...
	 */
	public function networkSerialize(?string $networkSerializedTiles, ?int $dimension) : string{
		$result = "";
		...
		$sections = min($subChunkCount, $maxSections);
		...
		$result .= str_repeat($encodedBiomePalette, $maxSections);
